...
ros::Time F1_close_stamp, F2_close_stamp, IMU_stamp;
...
void setup() {  
  ...
  mytimer.begin(setSendNMEA_ISR,1000000); // changes he nmea signal every 10^6 microsecond
